...
/**
 * Data source for the AdminCustomers view. This class should
...
export class AdminCustomersDataSource extends DataSource<AdminCustomersItem> {
   ...
   */
  connect(): Observable<AdminCustomersItem[]> {
   ...
   */
  private getPagedData(data: AdminCustomersItem[]) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: AdminCustomersItem[]) {
